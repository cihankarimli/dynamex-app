...
import ModalYoutube from "../components/ModalYoutubeCard";
  ...
  return (
    <>
      <div className="youtube-slider-container">
        ...
        >
          {YoutubeData.map((card) => (
            <SwiperSlide onClick={() => handleModalOpen(card.id)} key={card.id}>
      ...
      {openModal && selectedVideo && (
        <ModalYoutube videoId={selectedVideo} onClose={handleModalClose} />
      )}
    </>
  );
}
